    ...
    public partial class test1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FilialesDup", x => x.FilialeID);
                });

            migrationBuilder.CreateTable(
                name: "FournisseursDup",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FournisseursDup", x => x.FournisseurID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FournisseurDupFournisseurID = table.Column<Guid>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FicheCompresseurs", x => x.CompresseurID);
                    table.ForeignKey(
                        name: "FK_FicheCompresseurs_FournisseursDup_FournisseurDupFournisseurID",
                        column: x => x.FournisseurDupFournisseurID,
                        principalTable: "FournisseursDup",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FicheCompresseurs_FournisseurDupFournisseurID",
                table: "FicheCompresseurs",
                column: "FournisseurDupFournisseurID");
