...
namespace Pgh.Auth.Model.Models
{
    public class AuthDbContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                //192.168.60.94
                //  optionsBuilder.UseSqlServer(@"Data Server=(localdb)\\mssqllocaldb;Database=Pgh.AuthService;Trusted_Connection=True;MultipleActiveResultSets=true");
                optionsBuilder.UseSqlServer(@"Data Source=(localdb)\MSSQLLocalDB;Database=Pgh.AuthService;Trusted_Connection=True;MultipleActiveResultSets=true");
            }
        }
