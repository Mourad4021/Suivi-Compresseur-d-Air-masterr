...
namespace SuiviCompresseur.Infra.IoC
{
    public class DependencyContainer
    {
        public static void RegisterServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IGenericRepositoryResponsable<Utilisateur>, GenericRepositoryResponsable<Utilisateur>>();
            services.AddTransient<IRequestHandler<CreateGenericCommandGR<Utilisateur>, string>, CreateGenericHandlerGR<Utilisateur>>();
            services.AddTransient<IRequestHandler<GetGenericQueryGR<Utilisateur>, Utilisateur>, GetGenericHandlerGR<Utilisateur>>();
            services.AddTransient<IRequestHandler<PutGenericCommandGR<Utilisateur>, string>, PutGenericHandlerGR<Utilisateur>>();
            services.AddTransient<IRequestHandler<RemoveGenericCommandGR<Utilisateur>, string>, RemoveGenericHandlerGR<Utilisateur>>();
            services.AddTransient<IRequestHandler<GetAllGenericQueryGR<Utilisateur>, IEnumerable<Utilisateur>>, GetAllGenericHandlerGR<Utilisateur>>();
